...
Toolbar.prototype.init = function()
{
	...
	{
		viewMenu.style.width = (mxClientMin.IS_QUIRKS) ? '58px' : '50px';
	}
	else
	{
		viewMenu.style.width = (mxClientMin.IS_QUIRKS) ? '62px' : '36px';
	}
...
Toolbar.prototype.addDropDownArrow = function(menu, sprite, width, atlasWidth, left, top, atlasDelta, atlasLeft)
{
	...
	menu.innerHTML = '<div class="geSprite ' + sprite + '" style="margin-left:' + left + 'px;margin-top:' + top + 'px;"></div>' +
		this.dropdownImageHtml;
	menu.style.width = (mxClientMin.IS_QUIRKS) ? atlasWidth + 'px' : (atlasWidth - atlasDelta) + 'px';
	...
	if (EditorUi.compactUi)
	{
		...
		menu.style.width = (mxClientMin.IS_QUIRKS) ? width + 'px' : (width - 10) + 'px';
	}
};
...
Toolbar.prototype.createTextToolbar = function()
{
	...
	this.fontMenu.style.width = (mxClientMin.IS_QUIRKS) ? '80px' : '60px';
	...
	this.sizeMenu.style.width = (mxClientMin.IS_QUIRKS) ? '44px' : '24px';
	...
	alignMenu.style.width = (mxClientMin.IS_QUIRKS) ? '50px' : '30px';
	...
	formatMenu.innerHTML = '<div class="geSprite geSprite-dots" style="margin-left:-2px;"></div>' +
		this.dropdownImageHtml;
	formatMenu.style.width = (mxClientMin.IS_QUIRKS) ? '50px' : '30px';
	...
	insertMenu.innerHTML = '<div class="geSprite geSprite-plus" style="margin-left:-4px;margin-top:-3px;"></div>' +
		this.dropdownImageHtml;
	insertMenu.style.width = (mxClientMin.IS_QUIRKS) ? '36px' : '16px';
	...
	if (EditorUi.compactUi)
	{
		...
		insertMenu.style.width = (mxClientMin.IS_QUIRKS) ? '50px' : '30px';
	}
	...
	elt.style.width = (mxClientMin.IS_QUIRKS) ? '50px' : '30px';
