...
Actions.prototype.init = function()
{
	...
	this.addAction('redo', function() { ui.redo(); }, null, 'sprite-redo', (!mxClientMin.IS_WIN) ? Editor.ctrlKey + '+Shift+Z' : Editor.ctrlKey + '+Y');
	...
	this.addAction('help', function()
	{
		...
		if (mxResources.isLanguageSupported(mxClientMin.language))
		{
			ext = '_' + mxClientMin.language;
		}
