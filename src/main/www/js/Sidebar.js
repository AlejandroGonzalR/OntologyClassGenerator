...
function Sidebar(editorUi, container)
{
	...
	mxEvent.addListener(document, (mxClientMin.IS_POINTER) ? 'pointerup' : 'mouseup', this.pointerUpHandler);
	...
	mxEvent.addListener(document, (mxClientMin.IS_POINTER) ? 'pointerdown' : 'mousedown', this.pointerDownHandler);
	...
	mxEvent.addListener(document, (mxClientMin.IS_POINTER) ? 'pointermove' : 'mousemove', this.pointerMoveHandler);
	...
	mxEvent.addListener(document, (mxClientMin.IS_POINTER) ? 'pointerout' : 'mouseout', this.pointerOutHandler);
	...
	if (this.enableTooltips && this.showTooltips)
	{
		if (this.currentElt != elt)
		{
			...
			var show = mxUtils.bind(this, function()
			{
				...
				var fo = mxClientMin.NO_FO;
				mxClientMin.NO_FO = Editor.prototype.originalNoForeignObject;
				this.graph2.addCells(cells);
				mxClientMin.NO_FO = fo;
...
Sidebar.prototype.createThumb = function(cells, width, height, parent, title, showLabel, showTitle, realWidth, realHeight)
{
	...
	if (this.graph.dialect == mxConstants.DIALECT_SVG && !mxClientMin.NO_FO &&
	...
	{
		var border = (mxClientMin.IS_QUIRKS) ? 2 * this.thumbPadding + 2: 0;
...
Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted)
{
	...
	var border = (mxClientMin.IS_QUIRKS) ? 8 + 2 * this.thumbPadding : 2 * this.thumbBorder;
...
Sidebar.prototype.addFoldingHandler = function(title, content, funct)
{
	...
	if (!mxClientMin.IS_IE || document.documentMode >= 8)
	{
	...
	if (!mxClientMin.IS_QUIRKS)
	{
	    mxEvent.addListener(title, (mxClientMin.IS_POINTER) ? 'pointerdown' : 'mousedown',
...
Sidebar.prototype.destroy = function()
{
	...
	{
		mxEvent.removeListener(document, (mxClientMin.IS_POINTER) ? 'pointerup' : 'mouseup', this.pointerUpHandler);
		this.pointerUpHandler = null;
	}

	if (this.pointerDownHandler != null)
	{
		mxEvent.removeListener(document, (mxClientMin.IS_POINTER) ? 'pointerdown' : 'mousedown', this.pointerDownHandler);
		this.pointerDownHandler = null;
	}
	
	if (this.pointerMoveHandler != null)
	{
		mxEvent.removeListener(document, (mxClientMin.IS_POINTER) ? 'pointermove' : 'mousemove', this.pointerMoveHandler);
		this.pointerMoveHandler = null;
	}
	
	if (this.pointerOutHandler != null)
	{
		mxEvent.removeListener(document, (mxClientMin.IS_POINTER) ? 'pointerout' : 'mouseout', this.pointerOutHandler);
